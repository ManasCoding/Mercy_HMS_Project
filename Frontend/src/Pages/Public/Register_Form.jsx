      ...
      >
        ...
        <div className="flex items-center justify-center mt-4">
          ...
          <Button title="Register"
            className="bg-secondary text-white active:scale-110 rounded-3xl hover:bg-white hover:text-black px-3 py-2 border-2 border-secondary text-xl font-bold"
            type="submit"
          />
        </div>
      </form>
