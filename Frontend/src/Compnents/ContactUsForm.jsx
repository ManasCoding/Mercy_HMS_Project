...
import image from "../assets/mercy.jpg";
const ContactUsForm = () => {
    ...
    <div className="w-full h-[88vh] bg-[#F5F5F5] px-40 pt-10 pb-5">
      <div className="w-full h-full flex">
        <div className="w-2/5 relative">
          ...
          <div className="w-96 h-62 bg-[#D5D5D5] mt-10"><img src={image} alt="" className="w-full h-full objet-cover"/></div>
        </div>
        <div className="w-3/5">
          <form
          ...
          >
            ...
            <div className="">
              <Button variant="outlinePre" type="submit" title={"Submit"}/>
            </div>
          </form>
        </div>
      </div>
